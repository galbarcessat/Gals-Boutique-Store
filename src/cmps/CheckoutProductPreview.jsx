...
export function CheckoutProductPreview({ product }) {
    ...
    return (
        <div className="checkout-product-preview">
            <div className="product-info">
                ...
                <h1 onClick={() => navigate(`/product/${product._id}`)}>{product.title}</h1>
            </div>
            ...
            <div className="product-amount-changer-container">
            ...
            <div className="product-total-price">${product.amount * product.price}</div>
        </div>
    )
}